          ...
          child: Column(
            ...
            children: [
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Icon(
                      ...
                      size: 16.sp,
                      color: const Color(0xFF138A76),
                    ),
                  ),
                ),
              ),

              // Crown & Wreaths Header
              Row(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            ...
                            width: _selectedPlan == SubscriptionPlan.monthly ? 1.5.w : 1.0.w,
                          ),
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                child: _selectedPlan == SubscriptionPlan.monthly
                            ...
                            Text(
                              'month',
                              style: AppTypography.bodySmall.copyWith(fontSize: 11.sp),
                            ),
                          ],
                        ),
                      ),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(16.r),
                              border: Border.all(
                                color: _selectedPlan == SubscriptionPlan.yearly
                                    ? AppColors.primaryTeal
                                    : const Color(0xFFE2E8F0),
                                width: _selectedPlan == SubscriptionPlan.yearly ? 1.5.w : 1.0.w,
                              ),
                              boxShadow: AppColors.cardShadow,
                            ),
                            child: Column(
                              children: [
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: _selectedPlan == SubscriptionPlan.yearly
                                        ? Icon(Icons.check, size: 12.sp, color: Colors.white)
                                        : null,
                                  ),
                                ),
              ...
              CustomGradientButton(
                ...
                leadingIcon: Icon(Icons.diamond_outlined, color: Colors.white, size: 20.sp),
                trailingIcon: Icon(CupertinoIcons.arrow_right, color: Colors.white, size: 18.sp),
