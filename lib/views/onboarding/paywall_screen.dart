...
class _PaywallScreenState extends State<PaywallScreen> {
  ...
  void _onClose() {
    final bool wasOnboarding = !_appController.onboardingSeen.value;
    _appController.completeOnboarding();
    if (wasOnboarding || !Navigator.canPop(context)) {
            ...
            SafeArea(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    // Centered Crown
                    Image.asset(AppAssets.crown, width: 76.w, height: 76.w),
                    // Title
                    Row(
  ...
  Widget _buildFeatureRow({
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Image.asset(iconPath, fit: BoxFit.contain, height: 24.h, width: 24.w),
          SizedBox(width: 10.w),
          Expanded(
            child: Text(
              title,
          ...
          Image.asset(AppAssets.preDown, height: 16.h, width: 16.w),
        ],
      ),
    );
  }
